...
\begin{equation} \label{matriiseilla}
	...
	\end{bmatrix}.
\end{equation}
Nyt voidaan kertoa edellinen yhtälö puolittain vasemmalta Vandermonden matriisin transpoosilla $\transpose{\matr{V}}$, jolloin yhtälö saadaan seuraavaan muotoon:
\begin{equation} 
	\begin{bmatrix}
		1       & 1       & ...    & 1 \\
