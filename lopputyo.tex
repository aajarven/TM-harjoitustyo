...
\section{Pienimmän neliösumman ratkaisu kaksiulotteiselle havaintoaineistolle}
...
Kun parametrien $\beta_i$ varianssit $\sigma_i$ tunnetaan, saadaan niistä helposti keskihajonnat $s$, kun tiedetään, että $\sigma=s^2$ \cite{maol}.
